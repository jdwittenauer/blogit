...
namespace BlogIt.Services
{
    ...
    /// </summary>
    public class BlogItServiceFactory
    {
        ...
        public BlogItServiceFactory(string environment) : this()
        {
        ...
        public TChannel GetService<TChannel>(string uri)
        {
            ...
            if (((BlogItChannelFactory<TChannel>)OpenChannelFactories[key]).State == CommunicationState.Faulted ||
                ((BlogItChannelFactory<TChannel>)OpenChannelFactories[key]).State == CommunicationState.Closed)
            {
            ...
            TChannel service = ((BlogItChannelFactory<TChannel>)OpenChannelFactories[key]).CreateChannel();
        ...
        private BlogItChannelFactory<TChannel> InitializeChannelFactory<TChannel>(string uri)
        {
            EndpointAddress endpoint = new EndpointAddress(uri);
            BlogItChannelFactory<TChannel> factory = new BlogItChannelFactory<TChannel>(binding, endpoint);
